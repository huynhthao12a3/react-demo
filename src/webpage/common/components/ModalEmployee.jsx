							...
							<Form.Group className="mb-3">
								<InputGroup>
									<FloatingLabel label="Email" controlId="floatingEmail">
										<Form.Control type="text" placeholder="Email" name="employeeEmail" onChange={handleInputChange} value={formData.employeeEmail} disabled={disabledCondition} />
									</FloatingLabel>
								</InputGroup>
							</Form.Group>
						</Row>
							...
							<Form.Group as={Col} className="mb-3">
								<FloatingLabel label="Expired Date" controlId="floatingExpiredDate">
									<Form.Control
										...
										onChange={handleInputChange}
										value={formData.employeeEndDate ? new Date(formData.employeeEndDate).toISOString().substring(0, 10) : new Date("1970-01-01").toISOString().substring(0, 10)}
										disabled={disabledCondition}
									/>
								</FloatingLabel>
							</Form.Group>
