...
function EmployeeView(props) {
	...
	const fetchData = async () => {
		await axios
			.get("http://localhost:9999/tds/employee/getEmployee", {
				params: {
					name: inputValueName,
		...
		<div>
			<div>
				<form onSubmit={handleSubmit}>
					<label>
						Employee Name:
						<input type="text" value={inputValueName} onChange={handleInputChangeName}></input>
					</label>
					<br />
					<label>
						Employee Address:
						<input type="text" value={inputValueAddress} onChange={handleInputChangeAddress}></input>
					</label>
					<br />
